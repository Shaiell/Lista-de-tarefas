...
public class TarefaDAO implements ITaferaDAO{
    ...
    public boolean atualizar(Tarefa tarefa) {
        ...
        try{
            ...
            Log.e("INFO", "Erro ao atualiza tarefa"+ e.getMessage());
            return false;
        }
    ...
    public List<Tarefa> listar() {
        ...
        String sqlRecebe = "SELECT * FROM "+DbHelper.TABELA_TAREFAS+" ;";
        Cursor c =le.rawQuery(sqlRecebe,null);
